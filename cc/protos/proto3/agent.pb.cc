...
static ::_pb::Metadata file_level_metadata_proto3_2fagent_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_proto3_2fagent_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto3_2fagent_2eproto = nullptr;

const uint32_t TableStruct_proto3_2fagent_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Weights, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::Weights, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::Weights, _impl_.weight_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Weights)},
};
...
const char descriptor_table_protodef_proto3_2fagent_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022proto3/agent.proto\"3\n\007Weights\022\n\n\002id\030\001 "
  "\001(\005\022\014\n\004name\030\002 \001(\t\022\016\n\006weight\030\003 \003(\002b\006proto"
  "3"
  ;
static ::_pbi::once_flag descriptor_table_proto3_2fagent_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto3_2fagent_2eproto = {
    false, false, 81, descriptor_table_protodef_proto3_2fagent_2eproto,
    "proto3/agent.proto",
    &descriptor_table_proto3_2fagent_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_proto3_2fagent_2eproto::offsets,
    file_level_metadata_proto3_2fagent_2eproto, file_level_enum_descriptors_proto3_2fagent_2eproto,
    file_level_service_descriptors_proto3_2fagent_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto3_2fagent_2eproto_getter() {
  return &descriptor_table_proto3_2fagent_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto3_2fagent_2eproto(&descriptor_table_proto3_2fagent_2eproto);
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Weights.name"));
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::Metadata Weights::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto3_2fagent_2eproto_getter, &descriptor_table_proto3_2fagent_2eproto_once,
      file_level_metadata_proto3_2fagent_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::Weights*
Arena::CreateMaybeMessage< ::Weights >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Weights >(arena);
}
